...
Without tmux: `python -m jobscraper.cli all` then open `site/index.html`.
...
keywords (`boost_keywords` in `config/profile.yaml`). The dashboard shows the best-fitting resume and both
